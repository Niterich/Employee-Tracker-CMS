...
function addEmployee(){
    inquirer.prompt([
            ...
            inquirer.prompt([
                {
                    ...
                    name: "manager",
                    list: [
                        //somehow list all managers, maybe looping through a 'managers' array?
                    ]
                }
            ]).then(res => {
        ...
        const queryString = `INSERT INTO employee_table (first_name, last_name, role_id, manager_id) values (${res.fn}, ${res.ln}, ${roleNum}, ${ifManager});`
        connection.query(queryString, function (err, res) {
            if (err) throw err;
...
function addRole(){
    ...
    const queryString = "INSERT INTO role_table (title, salary, department_id) values (?, ?, ?);"
    connection.query(queryString, function (err, res) {
        if (err) throw err;
